const cinema  = require('../../configs/config');





cinema.findlistCinemaByIdCR = async function(id) {

    return cinema.query(`SELECT * FROM "Cinema" WHERE "ProvinceISN" = $1`,[id]);
  }
cinema.findRapmovieBySC = async function(showtimeISN){
  return cinema.query(`SELECT * FROM "Cinema" c JOIN  "Room" r ON (c."CinemaISN" = r."CinemaISN")
...
// })
// Rap.belongsTo(province)

// Rap.findByIdprovince = async function(id){
//   return Rap.findAll({
//       include:[{
//           model:province,
//          where:{id:id,},
...
//module.exports = Rap
// INSERT INTO "Raps"("TenRap","LoaiRap","DiaChi","KTNgang","KTDoc","provinceId","createdAt","updatedAt")
